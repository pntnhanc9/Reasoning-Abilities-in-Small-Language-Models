...
def create_benchmark_parser():
    ...
    parser.add_argument(
        ...
        help="The generator to use for creating the InferenceModel.",
    )
    parser.add_argument(
        "--planner-model",
        type=str,
        default="QuantTrio/Qwen3.5-9B-AWQ",
        help="The local HuggingFace model to use as the Planner (ModelGenerator).",
    )
    parser.add_argument(
        "--n-attempts",
        type=int,
